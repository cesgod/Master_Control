...
<head>
	...
	<title>:: CLYFSA :: DASHBOARD | FISCALIZACION REVIEW</title>
          ...
          <span class="align-middle">CLYFSA</span>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						<a class="sidebar-link" href="fiscal-review.php">
				...
				<div class="container-fluid p-0">
					...
					<div class="row mb-2 mb-xl-3">
						<div class="col-auto d-none d-sm-block">
							<h3><strong>Seguimiento de PDs</strong> Dashboard</h3><br><h2><strong>FISCALIZACION</strong></h2>
						</div>
							...
							<div class="card flex-fill">
								...
								<table class="table table-hover my-0" id="table_id">
									...
									<tbody>
										...
										$pd_ur = array();
										$ti = mysqli_query($conexion, "SELECT * FROM pd_ur WHERE ESTADO_DEOM = 'FINALIZADO' ");
										  while ($t = mysqli_fetch_assoc($ti)) {
											...
											$pd_ur["Estado"][] =$t['ESTADO_DEPROP'];
										  	...
										  	$tp = mysqli_query($conexion, "SELECT * FROM planos WHERE METER = '".$t['METER_NAME']."'");
											  while ($p = mysqli_fetch_assoc($tp)) {
											  	$pd_ur["Planos"][] = $p['DIR'];
											  }	
											...
											for ($i=0; $i < $limit; $i++) { 
												...
												echo '
														<tr '.$class.'>
															...
															if (($pd_ur["Estado_final"][$i])!= ""){ 
																echo '<td class="d-none d-md-table-cell">
																'.$pd_ur["Estado_final"][$i].'
																		...
																		<div class="modal fade" id="centeredModalPrimary_'.$i.'" tabindex="-1" role="dialog" aria-hidden="true">
																			<div class="modal-dialog modal-dialog-centered" role="document">
																				<div class="modal-content">
																					<form action="change_fiscal.php" method="POST">
																						<div class="modal-header">
