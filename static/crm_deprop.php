				...
				<div class="container-fluid p-0">
					...
					<div class="row mb-2 mb-xl-3">
						<div class="col-auto d-none d-sm-block">
							<h3><strong>CRM </strong> DEPROP</h3>
						</div>
						...
						<div class="col-auto ml-auto text-right mt-n1">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
									...
									<li class="breadcrumb-item active" aria-current="page">CRM DEPROP</li>
								</ol>
							</nav>
						</div>
					</div>
						...
						<div class="col-12 col-lg-12 col-xxl-12 d-flex">
							<div class="card flex-fill">
								...
								<table class="table table-hover my-0" id="table_id">
									<thead>
										<tr>
											<th class="d-none d-xl-table-cell">LISTA DE MATERIALES</th>
											<th class="d-none d-xl-table-cell">PLANO</th>
											<th class="d-none d-xl-table-cell">ESTADO DEPROP</th>
											<th class="d-none d-xl-table-cell">N DE SOLICITUD</th>
											<th class="d-none d-xl-table-cell">DIRECCION</th>
											<th class="d-none d-xl-table-cell">TRABAJO</th>
											<th class="d-none d-xl-table-cell">PUBLICO EXCLUSIVO</th>
											<th class="d-none d-xl-table-cell">DESCRIPCION</th>
											<th class="d-none d-xl-table-cell">MDL PROY MT MON</th>
											<th class="d-none d-xl-table-cell">MDL PROY MT TRI</th>
											<th class="d-none d-xl-table-cell">MDL PROY MT TIPO</th>
											<th class="d-none d-xl-table-cell">MDL PROY BT MON</th>
											<th class="d-none d-xl-table-cell">MDL PROY BT TRI</th>
											<th class="d-none d-xl-table-cell">MDL PROY BT TIPO</th>
											<th class="d-none d-xl-table-cell">HHP PROY</th>
											<th class="d-none d-xl-table-cell">FECHA PROY</th>
											<th class="d-none d-xl-table-cell">OBSERVACIONES</th>
											<th class="d-none d-xl-table-cell">NOTAS</th>
									...
									<tbody>
										...
										$data = array();
										$values = mysqli_query($conexion, "SELECT * FROM deprop ");
