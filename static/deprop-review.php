...
<head>
	...
	<title>:: CLYFSA :: DASHBOARD | DEPROP REVIEW</title>
				...
				<div class="container-fluid p-0">
					...
					<div class="row mb-2 mb-xl-3">
						<div class="col-auto d-none d-sm-block">
							<h3><strong>Seguimiento de PDs</strong> Dashboard</h3><br><h2><strong>DEPROP</strong></h2>
						</div>
												...
												echo '
														<tr '.$class.'>
															...
															<td class="d-none d-xl-table-cell">
																<form action="upload_deprop.php" method="POST">
																	<input type="hidden" value="'.$pd_ur["MeterName"][$i].'" name="position">
																	<button type="submit" class="btn btn-info">Cargar Plano</button>
																</form>	
