...
<head>
	...
	<title>:: CLYFSA :: DASHBOARD | DEOM REVIEW</title>
          ...
          <span class="align-middle">CLYFSA</span>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						<a class="sidebar-link" href="deom-review.php">
				...
				<div class="container-fluid p-0">
					...
					<div class="row mb-2 mb-xl-3">
						<div class="col-auto d-none d-sm-block">
							<h3><strong>Seguimiento de PDs</strong> Dashboard</h3><br><h2><strong>DEOM</strong></h2>
						</div>
								...
								<table class="table table-hover my-0" id="table_id">
									<thead>
										<tr>
                                            ...
                                            <th class="d-none d-md-table-cell">Observación DEPROP</th>
									...
									<tbody>
										...
										$pd_ur = array();
										$ti = mysqli_query($conexion, "SELECT * FROM pd_ur WHERE INFORME != '' ");
										  while ($t = mysqli_fetch_assoc($ti)) {
										  	...
										  	$pd_ur["Observacion_deprop"][] = $t['OBSERVACION_DEPROP'];
											...
											for ($i=0; $i < $limit; $i++) { 
												...
												echo '
																		...
																		echo "
																  		...
																  		<div class='alert alert-success alert-outline-coloured alert-dismissible' role='alert'>
																			...
																			<div class='alert-message'>
																				 Estado del Plano <strong><a href='$path/$file'>$file</a></strong><div style='float: right;'><input type='checkbox' name='status[]' value='$file' class='form-check-input'  style='width: 30px; height: 30px;' checked disabled></div>
																			</div>
																		</div>";
																		$pl_s = '';
																	}else{
																		 echo "
																		  		...
																		  		<div class='alert alert-secondary alert-outline-coloured alert-dismissible' role='alert'>
																					...
																					<div class='alert-message'>
																						 Estado del Plano <strong><a href='$path/$file'>$file</a></strong><div style='float: right;'><input type='checkbox' name='status[]' value='$file' class='form-check-input'  style='width: 30px; height: 30px;' ></div>
																					</div>
																				</div>";
																	}
																}
														...
														echo '
															...
															<td class="d-none d-md-table-cell">'.$pd_ur["Observacion_deprop"][$i].'</td>
															<td class="d-none d-md-table-cell '.$pd_ur["prioridad"][$i].'">'.$pd_ur["prioridad"][$i].'</td>';
															if (($pd_ur["Estado_Deom"][$i])!= ""){ 
																...
																'.$pd_ur["Estado_Deom"][$i].'
																		...
																		<div class="modal fade" id="centeredModalPrimary_'.$i.'" tabindex="-1" role="dialog" aria-hidden="true">
																			<div class="modal-dialog modal-dialog-centered" role="document">
																				<div class="modal-content">
																					<form action="change_deom.php" method="POST">
																						<div class="modal-header">
																							<h5 class="modal-title">Centered modal</h5>
																							<button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
																						</div>
																						<select id="dropdown" name="estado_proc">
